...
import mapper.GenderAnalysisQ4Mapper;
import reducer.GenderAnalysisQ4Reducer;
...
public class Q4MRUnitTest {
	...
	private Text mapperKey = new Text("United States Employment to population ratio, 15+, female (%) (national estimate)");
	private Text reducerKey = new Text("United States Employment to population ratio, 15+, female (%) (national estimate) from 2000 to 2016");
	...
	@Before
	public void setUp(){
		GenderAnalysisQ4Mapper mapper = new GenderAnalysisQ4Mapper();
		mapDriver = new MapDriver<LongWritable, Text, Text, Text>();
		mapDriver.setMapper(mapper);
		
		GenderAnalysisQ4Reducer reducer = new GenderAnalysisQ4Reducer();
